...
<body class="dark bg-black  flex items-center justify-center">
    <div
        ...
        shadow-gray-700">
        <div class="hidden bg-cover lg:block lg:w-1/2 transform transition-transform duration-300 hover:scale-110"
            style="background-image: url('logo/w-logo.png');">
        </div>
        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <div class="mt-4">
                <input id="email"
                    class="block w-full px-4 py-2 rounded-lg dark:bg-black dark:text-gray-300 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300"
                    type="email" />
            </div>

            <div class="flex items-center justify-between mt-4">
                <label for="password" class="text-white text-sm font-medium">Password</label>
                <span class="w-1/2 border-b dark:border-white lg:w-1/2"></span>
                <a href="#" class="text-xs font-medium text-white hover:underline">Forget
                    Password?</a>
            </div>
...
<script>
    // Get references to the password input and toggle icon
